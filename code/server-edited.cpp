...
OCRepresentation NmonResource::get(QueryParamsMap queries)
{
    ...
    std::cout << "\t\t before col " << m_var_value_col<< std::endl;
    std::cout << "\t\t before res " << m_var_value_reset<< std::endl;
    std::cout << "\t\t before tx " << m_var_value_tx<< std::endl;
    ...
    std::cout << "\t\t after col " << m_var_value_col<< std::endl;
    std::cout << "\t\t after res " << m_var_value_reset<< std::endl;
    std::cout << "\t\t after tx " << m_var_value_tx<< std::endl;
